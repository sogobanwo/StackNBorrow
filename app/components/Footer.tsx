...
export default function Footer() {
  return (
    <footer id="about" className="border-t border-border bg-[#e4e7f2]">
      <div className="mx-auto flex max-w-[1440px] flex-col items-center gap-6 px-6 py-10 sm:px-10 md:flex-row md:justify-between lg:px-[116px]">
